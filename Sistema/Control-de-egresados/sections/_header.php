<?php
	...
	{
		header('location: '.$httpProtocol.$host.$url.'index');
		exit;
	}
...
<html>
    ...
    <noscript>
        ...
        <div class="popup">
            ...
            <h1>Parece que no tienes javascript, haz clic <a href="https://www.enable-javascript.com/">aquí</a> para ver cómo activarlo</h1>
