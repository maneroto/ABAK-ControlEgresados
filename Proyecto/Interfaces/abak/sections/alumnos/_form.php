          ...
          <form class="col s12" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
            <div id="contacto">
              ...
              <div class="row">
                <div class="input-field col s12">
                  ...
                  <input id="correo" type="email" name="correo" value="<?php echo $correo;?>" placeholder="cuenta@dominio.com" required>
              ...
              <div class="row">
                ...
                <div class="input-field col s4">
                  <span class="error"><?php echo $lada_movilErr;?></span>
                    <select name="lada_movil" class="js-example-basic-single no-autoinit" style="width: 100%">
                ...
                <div class="input-field col s4">
                  ...
                  <label for="movil">Teléfono Móvil (7 digitos)</label>
              ...
              <div class="row">
                ...
                <div class="input-field col s4">
                  <span class="error"><?php echo $lada_fijoErr;?></span>
                    <select name="lada_fijo" class="js-example-basic-single no-autoinit" style="width: 100%">
                      <option value="" disabled selected>Lada regional</option>
                      <option value="744">744</option>
                      <option value="449">449</option>
                      <option value="241">241</option>
                ...
                <div class="input-field col s4">
                  ...
                  <label for="fijo">Teléfono Fijo (7 digitos)</label>
            ...
            <div id="personal">
              ...
              <div class="row">
                ...
                <div class="input-field col s6">
                  ...
                  <input id="domicilio" type="text" name="domicilio" value="<?php echo $domicilio;?>" placeholder="En mayúsculas sin acentos" required>
              ...
              <div class="row">
                <div class="input-field col s6">
                  ...
                  <span class="error"><?php echo $area_interesErr;?></span>
                </div>
                <div class="input-field col s6">
                  <i class="material-icons prefix">school</i>
                  <select name="grado_academico_obtenido">
                    <option value="" selected disabled>Grado académico obtenido</option>
                  ...
                  <span class="error"><?php echo $grado_academico_obtenidoErr;?></span>
                </div>
              </div>
              <div class="row">
                <div class="input-field col s12">
            ...
            <div id="academico">
              ...
              <div class="row">
                ...
                <div class="input-field col s6">
                  ...
                  <input name="universidad" id="universidad" type="text" placeholder="En mayúsculas sin acentos">
                  <label for="universidad">Nombre de la universidad</label>
                  <span class="error"><?php echo $universidadErr;?></span>
                </div>
              </div>
            </div>
            <div id="practicas">
              ...
              <div class="row">
                ...
                <div class="input-field col s6">
                  ...
                  <input name="ocupacion" type="text" id="ocupacion" placeholder="En mayúsculas sin acentos">
                  <label for="ocupacion">Lugar de ocupación</label>
                  <span class="error"><?php echo $ocupacionErr;?></span>
                </div>
              </div>
            </div>
            <div id="laboral">
              ...
              <div class="row">
                ...
                <div class="input-field col s6">
                  <i class="material-icons prefix">business</i>
                  <input name="ocupacion2" type="text" id="ocupacion2" placeholder="En mayúsculas sin acentos">
                  <label for="ocupacion2">Lugar de ocupación</label>
                  <span class="error"><?php echo $ocupacion2Err;?></span>
                </div>
              </div>
              <div class="row">
                <div class="input-field col s12">
            ...
            <div id="laboral2">
              ...
              <div class="row">
                ...
                <div class="input-field col s6">
                  <i class="material-icons prefix">business</i>
                  <input name="ocupacion3" type="text" id="ocupacion3" placeholder="En mayúsculas sin acentos">
                  <label for="ocupacion3">Lugar de ocupación</label>
                  <span class="error"><?php echo $ocupacion3Err;?></span>
                </div>
              </div>
            </div>
