$(function() {
            ...
            $("#jsGrid-custom").jsGrid({
                ...
                fields: [
                    ...
                    { name: "No control", type: "number", width: 130},
                    { name: "Nombre", type: "text", width: 250 },
                    { name: "Carrera", type: "select", items: db.carreras, valueField: "Id", textField: "Name" },
                    { name: "Grado", type: "select", items: db.grados, valueField: "Id", textField: "Name", width: 50 },
                    { name: "Estatus laboral", type: "select", items: db.status_laboral, valueField: "Id", textField: "Name", width: 100},
                    { name: "Edad", type: "text", width: 50 },
                    { name: "Sexo", type: "select", items: db.sexos, valueField: "Id", textField: "Name", width:50 },
