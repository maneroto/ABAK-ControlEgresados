            ...
            <div class="col s12 m6 l4">
              <div class="card">
                <div class="card-image waves-effect waves-block waves-light">
                  <img class="activator" src="<?php echo $httpProtocol.$host.$url.'img/encuestas/encuestas.jpg'?>" alt="alumnos-img">
                </div>
                <div class="card-content blue darken-4 white-text">
                  <span class="card-title activator">4to Semestre</span>
                </div>
                      ...
                      <form id="encuesta4" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
                        <div class="input-field col s10">
                          <div class="switch">
                            <label>
                              Cerrada
                              <input id="cuarto_switch" name="activarCuarto" type="checkbox">
                              <span class="lever"></span>
                              Abierta
                            </label>
                          </div>
                        </div>
                        <div id="fechas_cuarto">
                        ...
                        <button class="btn blue waves-effect waves-light" type="submit">Listo</button>
                      </form>
                    </p>
                  </div>
                </div>
