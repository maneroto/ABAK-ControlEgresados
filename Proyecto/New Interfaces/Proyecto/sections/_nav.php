<nav>
    <div class="nav-wrapper">
      ...
      <ul class="right hide-on-med-and-down">
        ...
        <li <?php if ($_SESSION['idrol'] != "DIRECTOR") echo "style='display:none;'"?>><a href="<?php echo $httpProtocol.$host.$url.'views/reportes.php'?>">Reportes</a></li>
...
<ul class="sidenav" id="mobile-demo">
    ...
    <li <?php if ($_SESSION['idrol'] != "DIRECTOR") echo "style='display:none;'"?>><a href="<?php echo $httpProtocol.$host.$url.'views/reportes.php'?>"><i class="small material-icons">insert_chart</i>Reportes</a></li>
