<?php
	...
	$js = '<script type="text/javascript" src="'.$httpProtocol.$host.$url.'js/jquery-3.3.1.min.js"></script>
        ...
        <script type="text/javascript" src="'.$httpProtocol.$host.$url.'js/select2.min.js"></script>
...
<html>
    <head>
        ...
        <link rel="stylesheet" href="<?php echo $httpProtocol.$host.$url.'css/select2.min.css'?>" type="text/css" />
